...
`
    ...
    function xt(e, t) {
        ...
        de(r, e);
        let n = [r, ...F(e)],
            i = typeof t == "function" ? Dn(n, t) : In(n, t, e);
    ...
    d(
        ...
        (e, { value: t, modifiers: r, expression: n }, { evaluate: i }) => {
            typeof n == "function" && (n = i(n)),
                n !== !1 &&
                    (!n || typeof n == "boolean" ? Hn(e, r, t) : Kn(e, n, t));
        }
    );
    function Kn(e, t, r) {
        Er(e, me, ""),
    ...
    var Ue = (e) => {
        ...
        si = /-(\w)/g,
        Ms = Ue((e) => e.replace(si, (t, r) => (r ? r.toUpperCase() : ""))),
        ai = /\B([A-Z])/g,
        Ns = Ue((e) => e.replace(ai, "-$1").toLowerCase()),
    ...
    function nn(e = !1, t = !1) {
        return function (n, i, o) {
            ...
            if (
                i === "__v_raw" &&
                o === (e ? (t ? Di : cn) : t ? Ni : an).get(n)
            )
                return n;
            let s = H(n);
            if (!e && s && ye(Wr, i)) return Reflect.get(Wr, i, o);
            let a = Reflect.get(n, i, o);
            return (Ve(i) ? rn.has(i) : pi(i)) || (e || N(n, "get", i), t)
                ? a
                : It(a)
                ? !s || !qe(i)
                    ? a.value
    ...
    y(
        "refs",
        (e) => (
            e._x_refs_proxy || (e._x_refs_proxy = B(ki(e))), e._x_refs_proxy
        )
    );
    function ki(e) {
        let t = [];
    ...
    function Wi(e, t, r, n) {
        ...
        r((s) => {
            ...
            for (let f = 0; f < w.length; f++) {
                let g = w[f];
                a[g]._x_effects && a[g]._x_effects.forEach(Se),
                    a[g].remove(),
                    (a[g] = null),
                    delete a[g];
            }
            ...
            for (let f = 0; f < p.length; f++) {
                ...
                let O = l[b],
                    ...
                    Ht = R(O);
                P(ae, Ht, o),
                    (ae._x_refreshXForScope = (En) => {
                        Object.entries(En).forEach(([Sn, vn]) => {
                            Ht[Sn] = vn;
                        });
                    }),
                    _(() => {
        ...
        let i = x(e, t),
            o = () => {
                ...
                return (
                    ...
                    (e._x_undoIf = () => {
                        C(a, (c) => {
                            c._x_effects && c._x_effects.forEach(Se);
                        }),
                            a.remove(),
