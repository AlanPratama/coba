...
@section('title', $anggota->f_nama)

@section('content')

    <div class="flex flex-col justify-center items-start gap-2 mb-3">
        <h3 class="text-xl"><span class="font-semibold">Nama:</span> {{ $anggota->f_nama }}</h3>
        <h3 class="text-xl"><span class="font-semibold">Username:</span> {{ $anggota->f_username }}</h3>
        <h3 class="text-xl"><span class="font-semibold">Tempat Lahir:</span> {{ $anggota->f_tempatlahir }}</h3>
        <h3 class="text-xl"><span class="font-semibold">Tanggal Lahir:</span> {{ $anggota->f_tanggallahir }}</h3>
    </div>
            ...
            <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                ...
                @forelse ($entriPeminjaman as $peminjaman)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="pl-6 py-4 font-bold">{{ $peminjaman->anggota->f_nama }}</td>
